...
Close-up gallery that pushes EVEngine's **procedural** tree / bush / rock materials
...
New texture recipes also available: `tex.bark`, `tex.foliage`, `tex.moss`, `tex.tree_atlas`.
