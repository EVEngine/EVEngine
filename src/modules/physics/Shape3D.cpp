...
Shape3D::Shape3D(World3D *world, Body3D *body, b3ShapeId shapeId,
                 PhysicsShapeHandle runtimeHandle, Kind kind, float a, float b, float c,
                 std::vector<float> hullVertices, int hullMaxVertices,
    ...
    : world_(world), body_(body), shapeId_(shapeId), runtimeHandle_(runtimeHandle), kind_(kind),
      a_(a), b_(b), c_(c),
