...
[[nodiscard]] EVENGINE_API_DOMAINS eve::Result<eve::Value> encodeClimbingActionDefinition(const ClimbingActionDefinition& action);
 ...
 */
[[nodiscard]] EVENGINE_API_DOMAINS eve::Result<ClimbingActionDefinition> decodeClimbingActionDefinition(const eve::Value& value);

/** @brief Encode one validated profile and all nested actions into canonical schema v4 data. */
[[nodiscard]] EVENGINE_API_DOMAINS eve::Result<eve::Value> encodeClimbingProfileDefinition(const ClimbingProfileDefinition& profile);
 ...
 */
[[nodiscard]] EVENGINE_API_DOMAINS eve::Result<ClimbingProfileDefinition> decodeClimbingProfileDefinition(const eve::Value& value);
