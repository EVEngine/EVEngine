 ...
 */
[[nodiscard]] eve::Result<eve::Value> encodeSkillCondition(
    const eve::decision::Condition& condition);
 ...
 */
[[nodiscard]] eve::Result<eve::decision::Condition> decodeSkillCondition(
