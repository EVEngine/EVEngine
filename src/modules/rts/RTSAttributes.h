...
public:
    ...
    [[nodiscard]] static eve::Result<double> read(Unit& unit,
                                                  std::string_view attribute);

    /** @brief Set one selected canonical base stat. */
    [[nodiscard]] static eve::Result<void> setBase(Unit& unit,
    ...
    [[nodiscard]] static eve::Result<eve::attributes::ModifierId> addModifier(
        Unit& unit, std::string id, std::string_view attribute,
    ...
    [[nodiscard]] static eve::Result<void> restore(
        Unit& unit, const eve::attributes::AttributeProjectionSnapshot& snapshot,
