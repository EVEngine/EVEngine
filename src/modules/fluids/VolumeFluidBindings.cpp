...
void exposeVolumeFluidType(ssq::Table& table) {
    ...
    contactTracker.addFunc("advance", [vm](VolumeFluidContactTracker* self, VolumeFluid* fluid, float threshold) {
        if (!fluid)
            return script::projectStatusResult(
                vm, Status::failure(Diagnostic::error(DiagnosticCode::InvalidArgument, "Missing contact source",
                                                      "fluids.volume.contacts")));
        auto events = self->advance(fluid->contacts(), threshold);
        if (!events) return script::projectStatusResult(vm, events.status());
        return script::projectStatusResult(vm, Status::success(), encodeVolumeFluidContactEvents(events.value()));
    });
    ...
    foam.addFunc("snapshot", [vm](VolumeFluidFoam* self) {
        return script::projectStatusResult(vm, Status::success(), encodeVolumeFluidFoam(self->snapshot()));
    });
    ...
    foam.addFunc("advance", [vm](VolumeFluidFoam* self, VolumeFluid* fluid, VolumeFluidDiffuse* pool, float dt) {
        if (!fluid || !pool)
            return script::projectStatusResult(
                vm, Status::failure(Diagnostic::error(DiagnosticCode::InvalidArgument, "Missing foam source or pool",
                                                      "fluids.volume.foam")));
        auto emitted = self->advance(*fluid, *pool, dt);
        if (!emitted) return script::projectStatusResult(vm, emitted.status());
        return script::projectStatusResult(vm, Status::success(), Value(int64_t(emitted.value())));
    });
    ...
    diffuse.addFunc("snapshot", [vm](VolumeFluidDiffuse* self) {
        return script::projectStatusResult(vm, Status::success(), encodeVolumeFluidDiffuse(self->snapshot()));
    });
    ...
    diffuse.addFunc("advance", [vm](VolumeFluidDiffuse* self, VolumeFluid* fluid, float dt, int minimumNeighbors) {
        if (!fluid)
            return script::projectStatusResult(
                vm, Status::failure(Diagnostic::error(DiagnosticCode::InvalidArgument, "Missing fluid field source",
    ...
    coupling.addFunc("attach", [vm](VolumeFluidCoupling* self, physics::Body3D* body, ssq::Object object) {
        if (!body)
            return script::projectStatusResult(
                vm, Status::failure(Diagnostic::error(DiagnosticCode::InvalidArgument, "Missing rigid body",
            ...
            if (!world || !fluid)
                return script::projectStatusResult(
                    vm, Status::failure(Diagnostic::error(DiagnosticCode::InvalidArgument,
                                                          "Missing rigid world or fluid", "fluids.volume.coupling")));
            auto result = self->step(*world, *fluid, dt, unsigned(substeps));
            if (!result) return script::projectStatusResult(vm, result.status());
            return script::projectStatusResult(vm, Status::success(), Value(int64_t(result.value())));
        });
    coupling.addFunc("stepWithThermalContacts", [vm](VolumeFluidCoupling* self, physics::World3D* world,
        ...
        const auto failure = [&](const Status& status) { return script::projectStatusResult(vm, status); };
        if (!world || !fluid)
    ...
    jet.addFunc("advance", [vm](VolumeFluidJetEmitter* self, VolumeFluid* solver, ssq::Object object, float dt,
        ...
        if (!solver)
            return script::projectStatusResult(
                vm, Status::failure(Diagnostic::error(DiagnosticCode::InvalidArgument, "Missing volume solver",
                                                      "fluids.volume.jet")));
        auto value = script::valueFromSquirrel(object);
        if (!value) return script::projectStatusResult(vm, value.status());
    ...
    cls.addFunc("setParticleWinds", [vm](VolumeFluid* self, ssq::Object object) {
        ...
        if (!winds) return script::projectStatusResult(vm, winds.status());
    ...
    cls.addFunc("setParticleExternalForces", [vm](VolumeFluid* self, ssq::Object object) {
        ...
        if (!forces) return script::projectStatusResult(vm, forces.status());
    ...
    cls.addFunc("accumulateWindZones", [vm](VolumeFluid* self, ssq::Object object, float fixedTimeSeconds) {
        ...
        if (!zones) return script::projectStatusResult(vm, zones.status());
    ...
    cls.addFunc("snapshot", [vm](VolumeFluid* self) {
        return script::projectStatusResult(vm, Status::success(), encodeVolumeFluid(self->snapshot()));
    });
    ...
    cls.addFunc("bindStaticParticles",
                [vm](VolumeFluid* self, ssq::Object object, int colliderLabel, bool constrainOrientation) {
                    ...
                    if (!indices) return script::projectStatusResult(vm, indices.status());
    ...
    cls.addFunc("setStitches", [vm](VolumeFluid* self, ssq::Object object) {
        ...
        if (!stitches) return script::projectStatusResult(vm, stitches.status());
    ...
    cls.addFunc("sampleField", [vm](VolumeFluid* self, ssq::Object object) {
        ...
        if (!positions) return script::projectStatusResult(vm, positions.status());
        auto samples = self->sampleField(positions.value());
        if (!samples) return script::projectStatusResult(vm, samples.status());
        return script::projectStatusResult(vm, Status::success(), encodeVolumeFluidFieldSamples(samples.value()));
    });
    cls.addFunc("debugParticleGrid", [vm](VolumeFluid* self, int maxCells) {
        ...
        if (!cells) return script::projectStatusResult(vm, cells.status());
        Value::Array encoded;
        ...
        return script::projectStatusResult(vm, Status::success(), Value(std::move(encoded)));
    });
    cls.addFunc("debugParticleFrames", [vm](VolumeFluid* self, int actorGroup, float size, int maxParticles) {
        ...
        if (!frames) return script::projectStatusResult(vm, frames.status());
        Value::Array encoded;
    ...
    cls.addFunc("particleInstances", [vm](VolumeFluid* self, int actorGroup, float sx, float sy, float sz, float alpha,
        ...
        if (!copied) return script::projectStatusResult(vm, copied.status());
        Value::Array encoded;
    ...
    cls.addFunc("debugSdfSlice",
                [vm](VolumeFluid* self, int colliderLabel, int axis, float slice, float maxDistance, int maxSamples) {
                    ...
                    if (!sampled) return script::projectStatusResult(vm, sampled.status());
    ...
    cls.addFunc("applyDataColors", [vm](VolumeFluid* self, int channel, ssq::Object object) {
        ...
        if (!gradient) return script::projectStatusResult(vm, gradient.status());
    ...
    cls.addFunc("teleportActor", [vm](VolumeFluid* self, ssq::Object currentObject, ssq::Object targetObject) {
        ...
        if (!currentValue) return script::projectStatusResult(vm, currentValue.status());
        auto targetValue = script::valueFromSquirrel(targetObject);
        if (!targetValue) return script::projectStatusResult(vm, targetValue.status());
        auto current = decodeVolumeFluidNozzlePose(currentValue.value());
        if (!current) return script::projectStatusResult(vm, current.status());
    ...
    cls.addFunc("actorMassProperties", [vm](VolumeFluid* self, int actorGroup) {
        if (actorGroup < 0)
            return script::projectStatusResult(
                vm, Status::failure(Diagnostic::error(DiagnosticCode::InvalidArgument,
                                                      "Actor group must be nonnegative", "fluids.volume.actorMass")));
        auto properties = self->actorMassProperties(unsigned(actorGroup));
        if (!properties) return script::projectStatusResult(vm, properties.status());
    ...
    cls.addFunc("updateActorMaterial", [vm](VolumeFluid* self, int actorGroup, ssq::Object emissionObject) {
        if (actorGroup < 0)
            return script::projectStatusResult(vm, Status::failure(Diagnostic::error(DiagnosticCode::InvalidArgument,
                                                                                     "Actor group must be nonnegative",
                                                                                     "fluids.volume.actorMaterial")));
        auto value = script::valueFromSquirrel(emissionObject);
        if (!value) return script::projectStatusResult(vm, value.status());
        auto emission = decodeVolumeFluidEmission(value.value());
        if (!emission) return script::projectStatusResult(vm, emission.status());
    ...
    cls.addFunc("killActorParticles", [vm](VolumeFluid* self, int actorGroup) {
        if (actorGroup < 0)
            return script::projectStatusResult(
                vm, Status::failure(Diagnostic::error(DiagnosticCode::InvalidArgument,
                                                      "Actor group must be nonnegative", "fluids.volume.killActor")));
    ...
    cls.addFunc("applyParticleDrag", [vm](VolumeFluid* self, int particleIndex, float x, float y, float z,
        ...
        if (particleIndex < 0)
            return script::projectStatusResult(
                vm, Status::failure(Diagnostic::error(DiagnosticCode::InvalidArgument,
                                                      "Particle index must be nonnegative", "fluids.volume.drag")));
        return script::projectResult(
    ...
    cls.addFunc("applyMaterialChannelsWithColors", [vm](VolumeFluid* self, ssq::Object object) {
        ...
        if (!keys) return script::projectStatusResult(vm, keys.status());
    ...
    cls.addFunc("overlapSphere", [vm](VolumeFluid* self, float x, float y, float z, float radius) {
        ...
        if (!hits) return script::projectStatusResult(vm, hits.status());
        return script::projectStatusResult(vm, Status::success(), encodeVolumeFluidParticles(hits.value()));
    });
    ...
    cls.addFunc("raycast", [vm](VolumeFluid* self, float ox, float oy, float oz, float dx, float dy, float dz,
        ...
        if (!hits) return script::projectStatusResult(vm, hits.status());
        return script::projectStatusResult(vm, Status::success(), encodeVolumeFluidRayHits(hits.value()));
    });
    cls.addFunc("querySphere", [vm](VolumeFluid* self, float x, float y, float z, float radius, float contactOffset,
        ...
        if (!hits) return script::projectStatusResult(vm, hits.status());
        return script::projectStatusResult(vm, Status::success(), encodeVolumeFluidDistanceHits(hits.value()));
    });
    ...
    cls.addFunc("queryBatch", [vm](VolumeFluid* self, ssq::Object object, int maxHitsPerQuery) {
        ...
        if (!queries) return script::projectStatusResult(vm, queries.status());
        auto hits = self->queryBatch(queries.value(), unsigned(maxHitsPerQuery));
        if (!hits) return script::projectStatusResult(vm, hits.status());
        return script::projectStatusResult(vm, Status::success(), encodeVolumeFluidQueryHits(hits.value()));
    });
    cls.addFunc("applyQueryColors", [vm](VolumeFluid* self, ssq::Object queryObject, ssq::Object colorObject, float r,
        ...
        if (!queryValue) return script::projectStatusResult(vm, queryValue.status());
        auto colorValue = script::valueFromSquirrel(colorObject);
        if (!colorValue) return script::projectStatusResult(vm, colorValue.status());
        auto queries = decodeVolumeFluidQueries(queryValue.value());
        if (!queries) return script::projectStatusResult(vm, queries.status());
        auto colors = decodeVolumeFluidColors(colorValue.value());
        if (!colors) return script::projectStatusResult(vm, colors.status());
        auto counts = self->applyQueryColors(queries.value(), colors.value(), {r, g, b, a}, unsigned(maxHitsPerQuery));
        if (!counts) return script::projectStatusResult(vm, counts.status());
        Value::Array encoded;
    ...
    cls.addFunc("setSimplexes", [vm](VolumeFluid* self, ssq::Object object) {
        ...
        if (!simplexes) return script::projectStatusResult(vm, simplexes.status());
    ...
    cls.addFunc("querySimplexes", [vm](VolumeFluid* self, ssq::Object object, int maxHitsPerQuery) {
        ...
        if (!hits) return script::projectStatusResult(vm, hits.status());
        return script::projectStatusResult(vm, Status::success(), encodeVolumeFluidSimplexHits(hits.value()));
    });
    ...
    cls.addFunc("contacts", [vm](VolumeFluid* self) {
        return script::projectStatusResult(vm, Status::success(), encodeVolumeFluidContacts(self->contacts()));
    });
