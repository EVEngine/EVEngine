...
public:
    explicit PropertyComponent(property_access::IPropertyAccess *model = nullptr,
     ...
     * @lifetime Valid until bind() replaces it or the model is destroyed; do not retain across frames without external lifetime control.
