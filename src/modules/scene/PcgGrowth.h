...
/** @brief Advance growth on a real scene node; returns true when it removed the node. */ [[nodiscard]] Result<bool> applyPcgGrowth(PcgGrowth& growth,SceneNodeRef& node,float now);
