...
/** @brief Link target kind for the generic per-node link system. */
enum class LinkKind {
    None = 0,
    Renderable2D,
    Renderable3D,
...
/**
 * @brief One generic link between a scene node and an external object (renderable,
...
public:
    ...
    /**
     * @brief Link an external object to a node id. Survives reconcile/rebuild by id.
