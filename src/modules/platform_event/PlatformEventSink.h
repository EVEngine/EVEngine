...
public:
     ...
     * @ownership nativeEvent is borrowed from the platform pump; the sink never owns it.
     * @lifetime nativeEvent is valid only for this synchronous call.
     */
    virtual bool shouldConsumePlatformEvent(const void* nativeEvent) { return false; }
     ...
     * @ownership nativeEvent is an immediate borrow; a returned Message transfers ownership.
     * @lifetime nativeEvent is valid only for this call; the returned Message remains valid until deleted.
     */
