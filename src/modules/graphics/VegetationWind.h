 ...
 */
[[nodiscard]] EVENGINE_API_BACKENDS Result<void> advanceVegetationWindAudio(VegetationWindAudioState& state,
                                                                            float windStrength, float transitionTime,
 ...
 */
[[nodiscard]] EVENGINE_API_BACKENDS Result<std::array<float, 14>> packVegetationWind(
    const VegetationWindState& state, const VegetationWindProfile& profile, double seconds);
 ...
 */
[[nodiscard]] EVENGINE_API_BACKENDS Result<void> initializeVegetationWind(VegetationWindState& state, glm::vec3 forward,
                                                                          float strength);
 ...
 */
[[nodiscard]] EVENGINE_API_BACKENDS Result<void> advanceVegetationWind(VegetationWindState& state, glm::vec3 forward,
