#version 450
// GBuffer fill for alpha-cutout cards (sprite-stack slices): identical to
// mesh3d_gbuffer.frag but discards fragments below the alpha cutoff so the
// depth/normal buffers follow the silhouette instead of the full quad.
