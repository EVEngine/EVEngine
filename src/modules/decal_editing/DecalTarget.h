...
using editing::EditRegion; using editing::GizmoSnapshot; using editing::IDomainOperationTarget;
using editing::IDomainOperationTargetStaging; using editing::IEditableTarget; using editing::IPropertyProvider;
