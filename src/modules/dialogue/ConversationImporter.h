...
[[nodiscard]] EVENGINE_API_ORCHESTRATION eve::Result<std::vector<ConversationAsset>> importYarnConversation(
...
[[nodiscard]] EVENGINE_API_ORCHESTRATION eve::Result<std::vector<ConversationAsset>> importTweeConversation(
    const std::string& source, const std::string& path, std::vector<ConversationDiagnostic>& diagnostics);
