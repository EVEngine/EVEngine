...
eve::Result<void> HouseGen::loadComponentsFromJson(const std::string &json) {
    return library_.loadFromJson(json);
}
        ...
        if (!value)
            return eve::script::projectResult(
                vm, eve::Result<void>::failure(eve::Diagnostic::error(
                        ...
                        "layout receiver must not be null", "layout", {}, "housegen.squirrel")));
    ...
    cls.addFunc("loadComponentsFromJson", [vm](HouseGen *value, const std::string &json) {
        if (!value)
            return eve::script::projectResult(
                vm, eve::Result<void>::failure(eve::Diagnostic::error(
                        eve::DiagnosticCode::InvalidArgument,
                        "HouseGen receiver must not be null", "housegen", {}, "housegen.squirrel")));
    ...
    cls.addFunc("generate", [vm](HouseGen *value, HouseRequest *request, HouseLayout *layout) {
        if (!value || !request || !layout)
            return eve::script::projectResult(
                vm, eve::Result<void>::failure(eve::Diagnostic::error(
                        eve::DiagnosticCode::InvalidArgument,
                        "HouseGen, request and layout are required", "generate", {},
                        "housegen.squirrel")));
