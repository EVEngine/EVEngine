...
class VoxelWorldTarget final : public virtual editing::IEditableTarget, public editing::IIntVolumeTarget {
public:
 ...
 */
[[nodiscard]] std::unique_ptr<VoxelWorldTarget> createVoxelWorldTarget(std::string id, voxel::VoxelWorld* world);
