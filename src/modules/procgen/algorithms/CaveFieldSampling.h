...
EVENGINE_API_DOMAINS float          sampleCaveDensity(const std::vector<float>& density, int nx, int ny, int nz, CaveFieldPoint point);
...
CaveFieldPoint projectToCaveDensitySurface(CaveFieldPoint meshPoint, const std::vector<float>& density, int nx, int ny,
                                           int nz);
EVENGINE_API_DOMAINS CaveResampledField resampleCaveDensity(const std::vector<float>& density, int nx, int ny, int nz, int factor);
