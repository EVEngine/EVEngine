...
public:
    ...
    [[nodiscard]] static eve::script::Borrowed<Params> resolve(ProcgenParamsHandleRef reference) noexcept;
    ...
    [[nodiscard]] eve::script::Borrowed<OutputSpec> resolveOutput(ProcgenOutputHandleRef reference) noexcept;
    ...
    [[nodiscard]] static eve::Result<ProcgenGridHandleRef> newGridHandle(int width, int height);
    /** @brief Resolves a grid as a non-owning observation. */
    [[nodiscard]] static eve::script::Borrowed<Grid2D> resolve(ProcgenGridHandleRef reference) noexcept;
    ...
    [[nodiscard]] eve::script::Borrowed<PointSet> resolvePointSet(ProcgenPointSetHandleRef reference) noexcept;
     ...
     */
    [[nodiscard]] static eve::script::Borrowed<image::ImageData> resolve(ProcgenImageHandleRef reference) noexcept;
    /**
    ...
    [[nodiscard]] eve::Result<float> cloudCoverageAt(ProcgenCloudFieldHandleRef field, float x, float z, float time);
    /** @brief Light multiplier in [0,1] using a live shadow handle. */
    [[nodiscard]] eve::Result<float> cloudShadowFactor(ProcgenCloudShadowHandleRef shadow, float x, float z,
                                                       float time);
    /** @brief Samples coverage into a caller-owned buffer after validating its size. */
    [[nodiscard]] eve::Result<void> sampleCloud(ProcgenCloudFieldHandleRef field, std::span<float> out, int w, int h,
    ...
    [[nodiscard]] eve::Result<void> sampleCloudShadow(ProcgenCloudShadowHandleRef shadow, std::span<float> out, int w,
                                                      int h, float time, float x0, float z0, float extent);
    /**
