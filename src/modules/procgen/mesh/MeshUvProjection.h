 ...
 */
[[nodiscard]] EVENGINE_API_DOMAINS Result<MeshBuild> projectMeshUvResult(const MeshBuild& input, std::string_view mode, float scale = 1.f,
 ...
 */
[[nodiscard]] EVENGINE_API_DOMAINS Result<MeshSurfaceUv> mapMeshSurfacePointToUvResult(const MeshBuild& mesh, int triangleIndex, float x,
                                                                  float y, float z);
