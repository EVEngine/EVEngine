...
private:
    friend Result<GtsMeshSplitResult> splitGtsMesh(const MeshBuild&,int,int,GtsMeshPivot);
 ...
 */
[[nodiscard]] Result<GtsMeshSplitResult> splitGtsMesh(
