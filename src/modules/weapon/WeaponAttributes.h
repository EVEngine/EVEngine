...
public:
    ...
    [[nodiscard]] static eve::Result<double> read(WeaponEntity& weapon,
                                                  std::string_view attribute);

    /** @brief Set a selected canonical base and refresh Resource compatibility fields. */
    [[nodiscard]] static eve::Result<void> setBase(WeaponEntity& weapon,
    ...
    [[nodiscard]] static eve::Result<eve::attributes::ModifierId> addModifier(
        WeaponEntity& weapon, std::string id, std::string_view attribute,
    ...
    [[nodiscard]] static eve::Result<void> restore(
        WeaponEntity& weapon, const eve::attributes::AttributeProjectionSnapshot& snapshot,
