...
public:
    ...
    [[nodiscard]] static eve::Result<double> read(VehicleEntity& vehicle,
                                                  std::string_view attribute);

    /** @brief Set a selected canonical base and refresh the compatibility health fields. */
    [[nodiscard]] static eve::Result<void> setBase(VehicleEntity& vehicle,
    ...
    [[nodiscard]] static eve::Result<eve::attributes::ModifierId> addModifier(
        VehicleEntity& vehicle, std::string id, std::string_view attribute,
    ...
    [[nodiscard]] static eve::Result<void> restore(
        VehicleEntity& vehicle, const eve::attributes::AttributeProjectionSnapshot& snapshot,
