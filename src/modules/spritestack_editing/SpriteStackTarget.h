...
namespace eve::spritestack { class SpriteStack2D; }
...
using editing::PropertyType; using editing::Revision; using editing::RuleId; using editing::SelectionSnapshot;
using editing::TargetDescriptor; using editing::TargetId;
...
private:
    ...
    std::string id_; Revision revision_=1; EditRegion dirty_; SpriteStackAssetValue value_;
};
...
public:
    ...
    EditorResult<spritestack::SpriteStack2D*> publish(graphics::Graphics* graphics,
...
private:
    ...
    SpriteStackAssetValue value_; Revision revision_=0;
};
