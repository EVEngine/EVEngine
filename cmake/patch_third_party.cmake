...
execute_process(
    COMMAND "${GIT_EXECUTABLE}" apply --reverse --check --ignore-space-change --unidiff-zero "${PATCH_ABS}"
...
execute_process(
    COMMAND "${GIT_EXECUTABLE}" apply --check --ignore-space-change --unidiff-zero "${PATCH_ABS}"
    WORKING_DIRECTORY "${PATCH_DIR_ABS}"
...
execute_process(
    COMMAND "${GIT_EXECUTABLE}" apply --ignore-space-change --unidiff-zero "${PATCH_ABS}"
    WORKING_DIRECTORY "${PATCH_DIR_ABS}"
