...
TEST_CASE("system.pcgFrameRateManager.matchesSamplingAndQualityPolicy"){
...
TEST_CASE("system.pcgFrameRateManager.manualAndFailureAreAtomic"){
...
}TEST_CASE("system.pcgFrameRateManager.squirrelContract"){
