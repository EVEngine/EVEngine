...
NSString *StageMarkerPath(NSString *root) { return [root stringByAppendingPathComponent:@".staged"]; }
    ...
    static const std::string root = []() -> std::string {
        @autoreleasepool {
            ...
            if (prev != nil && [prev isEqualToString:expected]) {
                ...
                [expected writeToFile:marker atomically:YES encoding:NSUTF8StringEncoding error:nil];
            }
